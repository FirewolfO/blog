...
const route = useRoute(); const posts = ref<Post[]>([]); const postId = ref(String(route.query.postId || '')); const comments = ref<Comment[]>([]); const content = ref(''); const loading = ref(false); const sending = ref(false)
